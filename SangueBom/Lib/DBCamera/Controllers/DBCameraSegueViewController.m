...
- (UIButton *) useButton
{
    if ( !_useButton ) {
        ...
        [_useButton setTitle:@"Usar" forState:UIControlStateNormal];
        _useButton.titleLabel.font = [UIFont customRegularFontWithSize:16.0];
...
- (UIButton *) retakeButton
{
    if ( !_retakeButton ) {
        ...
        [_retakeButton setTitle:@"Repetir" forState:UIControlStateNormal];
...
- (UIButton *) baseButton
{
    ...
    button.titleLabel.font = [UIFont customLightFontWithSize:16.0];
...
- (UICollectionViewCell *) collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.label setText:_filtersList[indexPath.row]];
