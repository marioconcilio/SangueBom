...
@property (nonatomic, strong) UIVisualEffectView *topContainerBar, *bottomContainerBar;
@property (nonatomic, strong) DBCameraLoadingView *loading;
...
//    self.navigationItem.title = @"Olar";
    [self.view addSubview:self.topContainerBar];
    [self.view addSubview:self.bottomContainerBar];
    
//    self.automaticallyAdjustsScrollViewInsets = NO;
    [_pageViewController didMoveToParentViewController:self];
    _pageViewController.view.frame = UIKeyWindow.frame;
    [_pageViewController setEdgesForExtendedLayout:UIRectEdgeAll];
...
//                    vc.collectionView.contentInset = UIEdgeInsetsMake(44, 0, 0, 0);
...
- (void) setNavigationTitleAtIndex:(NSUInteger)index
{
    ...
    _titleLabel.font = [UIFont customLightFontWithSize:18.0];
...
- (UIVisualEffectView *) topContainerBar
{
    if ( !_topContainerBar ) {
...
//        [_topContainerBar setBackgroundColor:RGBColor(0x000000, 1)];
        ...
        _topContainerBar = [[UIVisualEffectView alloc] initWithEffect:blurEffect];
        _topContainerBar.frame = (CGRect) {
        ...
        [closeButton setFrame:(CGRect){ 10, 0, 45, 45 }];
...
//        [_topContainerBar addSubview:closeButton];
        ...
        CGFloat w = CGRectGetWidth(closeButton.frame);
        _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(20 + w,
                                                                0,
                                                                CGRectGetWidth(self.view.bounds) - 40 - 2*w,
                                                                CGRectGetHeight(_topContainerBar.bounds))];
...
- (UIVisualEffectView *) bottomContainerBar
{
    if ( !_bottomContainerBar ) {
        UIBlurEffect *blurEffect = [UIBlurEffect effectWithStyle:UIBlurEffectStyleDark];
        _bottomContainerBar = [[UIVisualEffectView alloc] initWithEffect:blurEffect];
        _bottomContainerBar.frame = (CGRect) {
            .size.width = CGRectGetWidth(self.view.bounds),
            .size.height = 30,
            .origin.y = CGRectGetHeight(self.view.bounds) - 30,
        };
...
//        [_bottomContainerBar setBackgroundColor:RGBColor(0x000000, 1)];
        ...
        [_pageLabel setFont:[UIFont customLightFontWithSize:12]];
